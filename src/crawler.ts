...
export class Crawler {
    ...
    protected onLoadTooHighReceived(connection: Connection, crawlState: CrawlState) {
        try {
    ...
    protected listen(peer: PeerNode, connection: Connection, timeoutCounter: number = 0, crawlState: CrawlState) {
